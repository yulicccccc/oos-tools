...
# --- 1. RE-GENERATE WORD DOCX (FULL SENTENCES, NO BULLETS, ZERO INDENT, LEFT ALIGNED) ---
doc = Document()
...
doc.save(docx_out)
print(f"Saved Word table with full sentences and ZERO bullets: {docx_out}")

# --- 2. UPDATE HTML FILE (FULL SENTENCES, NO BULLETS) ---
html_rows = ""
...
with open(html_out, "w", encoding="utf-8") as f:
    f.write(full_html)
print(f"Saved clean HTML with full sentences: {html_out}")

# --- 3. RE-COPY TO CLIPBOARD WITH ZERO BULLETS AND FULL SENTENCES ---
HEADER = """Version:0.9
...
try:
    ...
    win32clipboard.SetClipboardText("OOS-261186 Review Email Table (Full Sentences)")
