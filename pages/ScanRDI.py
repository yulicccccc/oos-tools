...
def generate_p2_docs():
    ...
    smart_p2_narrative = (f"RETEST UNDER SUBMISSION {st.session_state.retest_sample_id}\n\n"
        ...
        f"A final disinfection step was completed immediately before the samples were introduced into the ISO 5 Biological Safety Cabinet (BSC), E00{st.session_state.retest_bsc_id}, located within the {r_loc}, (Suite {r_suite}{r_suffix}), All activities were performed in accordance with MICRO-SOP-12, Rapid Scan RDI® Test using FIFU Method.\n\n"
        f"{retest_equip_sum}\n\n"
        f"The analyst, {r_name}, confirmed that the Scan RDI equipment E00{st.session_state.retest_scan_id} was set up as per ENG-SOP-4 (Scan RDI® System – Operations (Standard C3 Quality Check and Microscope Setup) and Maintenance), and the negative control and the positive control for the analyst, {r_name}, yielded expected results.\n\n"
        ...
        f"All reagents and supplies utilized during the testing process were within the expiration dates. Daily verifications (Control Beads), negative and positive controls, were conducted to confirm the reliability of the testing process. All verification tests met the set forth criteria per MICRO-SOP-12 (Rapid Scan RDI® Test using FIFU Method), and ENG-SOP-4 (Scan RDI® System – Operations (Standard C3 Quality Check and Microscope Setup) and Maintenance).\n\n"
